...
const I18n = (function () {
  ...
  const TEXTOS = {
    pt: {
      ...
      confirmar_senha_exemplo: 'digite a senha de novo',
      ...
      erro_senhas_diferentes: 'As senhas não são iguais. Digite a mesma senha nos dois campos.',
      erro_senha_longa: 'A senha é longa demais.',
      erro_credenciais_invalidas: 'E-mail ou senha incorretos.',
      sessao_expirou: 'Você ficou 3 dias sem entrar. Informe e-mail e senha para continuar.',
      linguagens: 'Linguagens',
      voltar_linguagens: 'Voltar para a escolha de linguagem',
      ver_linguagens: 'Ver as linguagens sem conta',
    ...
    en: {
      ...
      confirmar_senha_exemplo: 'type the password again',
      ...
      erro_senhas_diferentes: 'The passwords do not match. Type the same password in both fields.',
      erro_senha_longa: 'The password is too long.',
      erro_credenciais_invalidas: 'Wrong e-mail or password.',
      sessao_expirou: 'You have been away for 3 days. Enter your e-mail and password to continue.',
      linguagens: 'Languages',
      voltar_linguagens: 'Back to language choice',
      ver_linguagens: 'Browse the languages without an account',
